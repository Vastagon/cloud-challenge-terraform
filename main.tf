...
resource "azurerm_linux_function_app" "linux-function-app" {
  ...
  app_settings = {
    "CosmosDB" = "AccountEndpoint=https://vastagoncosmosdb.documents.azure.com:443/;AccountKey=CBPepTDdqn3FAHijV10kUcukwsp5GivZ1bb4M8TAcxiJdlGCjKYuLkmzbrYa30p8fqafrbjxxuszACDbuot7xA==;"
